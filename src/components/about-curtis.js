...
const AboutCurtis = () => {
  return (<section id="About_Curtis"> <div className="inner-wrapper"> <h2> About Curtis </h2> <p><span>I am just your typical</span> everyday, outgoing, happy, almost middle-aged, bald,
    ...
    Puppeteer, Raspberry - pi, AWS Apache, Sqlite, X - Code, Android Studio, and of course jQuery, Underscore, SCSS / CSS and HTML5.I also know React, React - Native, Angular, PHP, Liquid and I dabbled in Java about 10 years ago.I have built out sites using Wordpress.org,
    Gatsbyjs and Shopify.I am always looking for opportunities to learn more and learn from other people so if you have time to play code please feel free to contact me. </p> </div> </section >)
}
